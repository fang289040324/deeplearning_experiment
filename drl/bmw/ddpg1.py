...
class Actor(object):
    ...
    def _build_net(self, s, scope, trainable):
        with tf.variable_scope(scope):
            ...
            net = tf.layers.dense(s, 3000, activation=tf.nn.relu, kernel_initializer=init_w, bias_initializer=init_b, name='l1', trainable=trainable)
    ...
    def save(self):
        self.saver.save(self.sess, 'model/Actor.model')
...
class Critic(object):
    ...
    def save(self):
        self.saver.save(self.sess, 'model/Critic.model')
    ...
    for i in range(MAX_EPISODES):
        ...
        for j in range(MAX_EP_STEPS):
            ...
            if M.pointer > MEMORY_CAPACITY:
                ...
                print(critic.learn(b_s, b_a, b_r, b_s_))
                actor.learn(b_s)
