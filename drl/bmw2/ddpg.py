...
def train(train_indicator=1):
    ...
    for i in range(episode_count):
        ...
        for j in range(max_steps):
            ...
            noise_t[0][0] = train_indicator * max(epsilon, 0) * OU.function(a_t_original[0][0], 10.0, 1, 10)
            noise_t[0][1] = train_indicator * max(epsilon, 0) * OU.function(a_t_original[0][1], 0, 1, 5)

            a_t[0][0] = a_t_original[0][0] + noise_t[0][0]
            a_t[0][1] = a_t_original[0][1] + noise_t[0][1]

            s_t1, r_t, _, index_t1 = env.step(a_t[0], index)
