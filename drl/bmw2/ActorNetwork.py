...
class ActorNetwork(object):
    ...
    def create_actor_network(self, state_size, action_dim):
        ...
        h0 = k.layers.Dense(800, activation='relu')(S)
        h1 = k.layers.Dense(800, activation='relu')(h0)
        h1 = k.layers.Dense(1000, activation='relu')(h1)
        h1 = k.layers.Dense(600, activation='relu')(h1)
        h1 = k.layers.Dense(500, activation='relu')(h1)
        ...
        yaw_ = k.layers.Lambda(lambda yaw: yaw * 30)(yaw)
